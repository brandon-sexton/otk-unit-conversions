import {degreesToDMS, dmsToDegrees} from '../src/convert-angle';

test('p.20 Test #19 reverse', () => {
  const dmsSign = degreesToDMS(13.069444444444444);
...
test('p.20 Test #21 reverse', () => {
  const dmsSign = degreesToDMS(300.3333333333333);
...
test('p.20 Test #20', () => {
  const dmsSign = degreesToDMS(-0.5083333333333);
...
test('p.20 Test #22', () => {
  const dmsSign = degreesToDMS(10.2958);
